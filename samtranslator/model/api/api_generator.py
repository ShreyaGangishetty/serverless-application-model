...
class ApiGenerator(object):
    ...
    def _construct_stage(self, deployment, swagger, function_names):
        ...
        if swagger is not None:
            deployment.make_auto_deployable(stage, self.remove_extra_stage, swagger, self.domain, function_names)
    ...
    def to_cloudformation(self, function_names):
        ...
        stage = self._construct_stage(deployment, swagger, function_names)
